...
//    private final ResourceLocation id;
    ...
    public GrindstonePolishingRecipe(String recipeGroup, List<Ingredient> pIngredients, ItemStack result, int experience) {
...
//        return level.recipeAccess().. .getAllRecipesFor(SMRecipeTypes.GRINDSTONE_POLISHING.get());
//    }
    ...
    public static class Serializer implements RecipeSerializer<GrindstonePolishingRecipe> {
        ...
        //  "ingredients": [
        //    {
        //      "item": "sullysmod:rough_jade_brick_slab"
        //    }
        //  ],
        //  "result": {
        //    "item": "sullysmod:jade_brick_slab"
        //  }
        public static final MapCodec<GrindstonePolishingRecipe> CODEC = RecordCodecBuilder.mapCodec(instance->instance.group(
                Codec.STRING.optionalFieldOf("group", "").forGetter(r->r.recipeGroup),
        ...
        ).apply(instance, GrindstonePolishingRecipe::new));
        public static final StreamCodec<RegistryFriendlyByteBuf, GrindstonePolishingRecipe> PACKET_CODEC = StreamCodec.composite(
                ByteBufCodecs.STRING_UTF8, r->r.recipeGroup,
                Ingredient.CONTENTS_STREAM_CODEC.apply(ByteBufCodecs.list()), r->r.ingredients,
                ItemStack.STREAM_CODEC, r->r.result,
                ByteBufCodecs.INT, r->r.experience,
                GrindstonePolishingRecipe::new
        );
...
//        }
        ...
        @Override
        public MapCodec<GrindstonePolishingRecipe> codec() {
            return CODEC;
        }

        @Override
        public StreamCodec<RegistryFriendlyByteBuf, GrindstonePolishingRecipe> streamCodec() {
            return PACKET_CODEC;
        }
    }
}
