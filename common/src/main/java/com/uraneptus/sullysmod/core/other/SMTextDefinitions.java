...
public class SMTextDefinitions {
    ...
    public static void init() {
        ...
        JADE_UPGRADE = SMTextUtil.addTranslatable(Util.makeDescriptionId("upgrade", location("jade_upgrade")), "Jade Upgrade").withStyle(TITLE_FORMAT);
    ...
    private static ResourceLocation jadeUpgradeString(String suffix) {
        return location("smithing_template.jade_upgrade.").withSuffix(suffix);
    }
