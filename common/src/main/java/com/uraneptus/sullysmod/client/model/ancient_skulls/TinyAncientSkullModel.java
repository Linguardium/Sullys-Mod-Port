...
public class TinyAncientSkullModel extends AbstractAncientSkullModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(location("tiny"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -6.0F, -2.5F, 6.0F, 6.0F, 5.0F, new CubeDeformation(0.0F))
