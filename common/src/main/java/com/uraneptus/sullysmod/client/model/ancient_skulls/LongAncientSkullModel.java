...
public class LongAncientSkullModel extends AbstractAncientSkullModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(location("long"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -4.0F, -8.0F, 7.0F, 4.0F, 13.0F, new CubeDeformation(0.0F)),
