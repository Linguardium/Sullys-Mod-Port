...
public class BoulderingZombieModel extends ZombieModel<BoulderingZombieRenderState> {
    ...
    @Override
    public void setupAnim(BoulderingZombieRenderState renderState) {
        ...
        this.animate(renderState.climbAnimationState,BoulderingZombieAnimation.CLIMB, renderState.ageInTicks);
    }
